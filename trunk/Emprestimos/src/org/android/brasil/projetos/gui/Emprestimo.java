...
public class Emprestimo extends ListActivity {
    ...
    private void fillData() {
        Cursor notesCursor = mDbHelper.consultarTodos();
        startManagingCursor(notesCursor);

        // Create an array to specify the fields we want to display in the list (only TITLE)
        String[] from = new String[]{EmprestimoDbAdapter.KEY_ITEM};
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case DELETE_ID:
                ...
                mDbHelper.deleteEmprestimo(info.id);
                fillData();
                return true;
        }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent i = new Intent(this, EditarEmprestimo.class);
        i.putExtra(EmprestimoDbAdapter.KEY_ID, id);

...
public class DbAdapter {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		 ...
		 * Não esta claro se deverá ficar na versão final como valores default.
		 * 
		 * @param db
		 */
		private void insertDummyData(SQLiteDatabase db) {
			...
			db.execSQL(sql, new String[]{"otavio", "Matemética (Matéria Teste)", "44", "Este é um teste", "N"});
			db.execSQL(sql, new String[]{"julio", "Histéria (Matéria Teste)", "100", "Este é um teste", "N"});
	...
	/**
     * Abre o banco de dados. Se nãoo puder ser aberto, tenta criar uma nova instância do banco.
	...
	public long inserirMateria(MateriaVO materiaVO) {
		...
		// Apesar de ID ser a verdadeira chave do registro, os nomes das matérias devem ser unicos.
...
//	}
	...
	public long inserirTurma(TurmaVO turmaVO) {
		// Apesar de ID ser a verdadeira chave do registro, os nomes das turmas devem ser unicos.

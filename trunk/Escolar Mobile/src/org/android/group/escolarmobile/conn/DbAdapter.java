...
/**
 * Classe para comunicação com o banco de dados. Realiza todas as operações de criação, inserção, remoção, 
...
public class DbAdapter {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		private void insertDummyData(SQLiteDatabase db) {
			...
			db.execSQL(sql, new String[]{"otavio", "PortuguÃªs (Matéria Teste)", "40", "Este é um teste", "N"});
			...
			db.execSQL(sql, new String[]{"neto", "FÃ­sica (Matéria Teste)", "85", "Este é um teste", "N"});
			db.execSQL(sql, new String[]{"neto", "QuÃ­mica (Matéria Teste)", "10", "Este é um teste", "N"});
	...
	/**
     * Abre o banco de dados. Se não puder ser aberto, tenta criar uma nova instÃ¢ncia do banco.
     * Se não puder ser criada, lançaa uma exceção para sinalizar a falha.
     * 
     * @return this (auto-referï¿½ncia, permitindo encadear métodos na inicialização).
	 ...
	 * 
	 * @param key Nome da coluna usada como parÃ¢metro na consulta.
	...
	/**
	 * Cria um novo registro de aluno na tabela. Se o registro for incluÃ­do com
	...
	/**
	 * Cria um novo registro de matéria na tabela. Se o registro for incluÃ­do com
	 * sucesso, o RowID será retornado. Em caso de erro, retorna -1.
	 * 
	...
	/**
	 * Cria relaçÃµes entre as matérias e as turmas às quais ela pertence.
	 * 
	 * @param materiaVO InformaçÃµes sobre a matéria (id da matéria e id(s) da(s) turma(s)).
	...
	/**
	 * Remove todas as incidÃªncias de uma determinada matéria na tabela de relaçÃµes Matérias X Turmas.
	 * 
	...
	/**
	 * Retorna o registro das matrÃ­culas com o ID de aluno fornecido, se existir.
	 * 
	 * @param id
	...
	/**
	 * Método privado para realizar consultas de matrÃ­culas.
	 * 
	 * @param key Nome da coluna usada como parÃ¢metro na consulta.
	 * @param value Valor a ser procurado na coluna especificada.
	 * @return
	...
	/**
	 * Cria um novo registro de matrÃ­cula na tabela. Se o registro for incluÃ­do com
	 * sucesso, o RowID será retornado. Em caso de erro, retorna -1.
	 * 
	 * @param matriculaVO DAO com os dados da matrÃ­cula.
	 * @return rowID ou -1 se falhou.
	 *
	...
	/**
	 * Remove a matrÃ­cula com o id especificado.
	 * 
	 * @param id
	 * @return
	 */
...
//	}
	...
	/**
	 * Cria um novo registro de nota na tabela. Se o registro for incluÃ­do com
	 * sucesso, o RowID será retornado. Em caso de erro, retorna -1.
	 * 
	...
	/**
	 * Cria um novo registro de presença na tabela. Se o registro for incluÃ­do com
	 * sucesso, o RowID será retornado. Em caso de erro, retorna -1.
	 * 
	...
	/**
	 * Cria um novo registro de professor na tabela. Se o registro for incluÃ­do com
	 * sucesso, o RowID será retornado. Em caso de erro, retorna -1.
	 * 
	...
	/**
	 * Cria um novo registro de turma na tabela. Se o registro for incluÃ­do com
	 * sucesso, o RowID será retornado. Em caso de erro, retorna -1.
	 * 
